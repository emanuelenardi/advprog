...
\institute{%
    ...
    \begin{itemize}
        \item operatori di conversione di tipo e come usarli;
...
\begin{center}\Large
    \href{https://www.github.com/emanuelenardi/advprog}{\faicon{code-fork} \textbf{github.com/emanuelenardi/advprog}}
\end{center}
